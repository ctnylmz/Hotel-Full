...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class TestimonialController : Controller
    {
        ...
        public async Task<IActionResult> Add(TestimonialViewModel testimonial)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7199/api/Testimonial/Add", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"https://localhost:7199/api/Testimonial/Get/{id}");
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                ...
                var responseDelete = await client.PostAsync("https://localhost:7199/api/Testimonial/Delete", stringContent);
        ...
        public async Task<IActionResult> Update(TestimonialViewModel testimonial)
        {
            ...
            var jsonData = JsonConvert.SerializeObject(testimonial);
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            var responseMessage = await client.PostAsync("https://localhost:7199/api/Testimonial/Update", stringContent);
