...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class ServiceController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:44344/api/Service/GetList");
        ...
        public async Task<IActionResult> Add(ServiceViewModel service)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:44344/api/Service/Add", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"https://localhost:44344/api/Service/Get/{id}");
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                ...
                var responseDelete = await client.PostAsync("https://localhost:44344/api/service/Delete", stringContent);
        ...
        public async Task<IActionResult> Update(ServiceViewModel service)
        {
            ...
            var jsonData = JsonConvert.SerializeObject(service);
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            var responseMessage = await client.PostAsync("https://localhost:44344/api/Service/Update", stringContent);
