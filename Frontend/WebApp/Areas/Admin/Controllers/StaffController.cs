...
namespace WebApp.Areas.Admin.Controllers
{
    public class StaffController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:44344/api/Staff/GetList");
        ...
        public async Task<IActionResult> Add(StaffViewModel staff)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:44344/api/Staff/Add", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"https://localhost:44344/api/Staff/Get/{id}");
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                ...
                var responseDelete = await client.PostAsync("https://localhost:44344/api/Staff/Delete", stringContent);
        ...
        public async Task<IActionResult> Update(StaffViewModel staff)
        {
            ...
            var jsonData = JsonConvert.SerializeObject(staff);
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            var responseMessage = await client.PostAsync("https://localhost:44344/api/Staff/Update", stringContent);
